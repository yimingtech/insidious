 ...
 * @Date: 2021/12/9
 */
public class MyBatisListener extends BaseTraceListener {

    private final String CLASS = "org.apache.ibatis.binding.MapperProxy";
    private final String METHOD = "invoke";

    public MyBatisListener(ThreadCompressIntercepter intercepter, ModuleEventWatcher moduleEventWatcher) {
